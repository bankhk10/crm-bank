...
export function generateRandomCompany(overrides: Partial<CompanyRandomPayload> = {}): CompanyRandomPayload {
  ...
  const email = `${shortName.replace(/[^a-zA-Z0-9]/g, "").toLowerCase()}@example.com`;
