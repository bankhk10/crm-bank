...
export function SectionHeader({
  ...
  return (
    <div
      className={`flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4 sm:mb-6 bg-gray-300 px-4 sm:px-6 py-3 sm:py-4 rounded-lg sm:rounded-xl ${
        className || ""
      }`}
    >
