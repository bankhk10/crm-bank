  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        DayButton: (dayProps) => {
          const hasSelection = !!(props as any).selected;
          return <CalendarDayButton {...dayProps} hasSelection={hasSelection} />;
        },
...
function CalendarDayButton({
  ...
  hasSelection,
  ...props
}: React.ComponentProps<typeof DayButton> & { hasSelection?: boolean }) {
  const defaultClassNames = getDefaultClassNames()
  ...
  const isActuallyToday = modifiers.today && !hasSelection;
  ...
  return (
    <Button
      ...
      className={cn(
        "data-[today=true]:bg-blue-600 data-[today=true]:text-white data-[today=true]:rounded-md",
