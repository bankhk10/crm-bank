...
async function main() {
  ...
  // Region Sales Targets - 6 ภาค
  const regionTargets = [
    { region: "ภาคเหนือ", monthlyTarget: 500000, yearlyTarget: 6000000 },
    {
      region: "ภาคตะวันออกเฉียงเหนือ",
      monthlyTarget: 800000,
      yearlyTarget: 9600000,
    },
    { region: "ภาคตะวันออก", monthlyTarget: 700000, yearlyTarget: 8400000 },
    { region: "ภาคตะวันตก", monthlyTarget: 400000, yearlyTarget: 4800000 },
    { region: "ภาคกลาง", monthlyTarget: 1000000, yearlyTarget: 12000000 },
    { region: "ภาคใต้", monthlyTarget: 600000, yearlyTarget: 7200000 },
  ];

  // Create monthly targets for current month and yearly targets
  for (const rt of regionTargets) {
    ...
    await prisma.regionSalesTarget.upsert({
      ...
      update: { targetAmount: rt.monthlyTarget },
      create: {
        region: rt.region,
        year: currentYear,
        month: currentMonth,
        targetAmount: rt.monthlyTarget,
        notes: `เป้ายอดขายรายเดือน ${rt.region}`,
      },
    });

    // Yearly target (month = null means yearly)
    await prisma.regionSalesTarget.upsert({
      where: {
        region_year_month: {
          region: rt.region,
          year: currentYear,
          month: null as any, // null for yearly target
        },
      },
      update: { targetAmount: rt.yearlyTarget },
      create: {
        region: rt.region,
        year: currentYear,
        month: null,
        targetAmount: rt.yearlyTarget,
        notes: `เป้ายอดขายรายปี ${rt.region}`,
      },
    });
  }

  // Product Group Sales Targets
  const productGroupTargets = [
    { group: "SEP", monthlyTarget: 600000, yearlyTarget: 7200000 },
    { group: "AMN", monthlyTarget: 700000, yearlyTarget: 8400000 },
    { group: "ISPI", monthlyTarget: 500000, yearlyTarget: 6000000 },
    { group: "24D", monthlyTarget: 400000, yearlyTarget: 4800000 },
    { group: "ABA", monthlyTarget: 550000, yearlyTarget: 6600000 },
    { group: "OTH", monthlyTarget: 350000, yearlyTarget: 4200000 },
  ];

  for (const pgt of productGroupTargets) {
    await prisma.productGroupSalesTarget.upsert({
      where: {
        productGroup_year_month: {
          productGroup: pgt.group,
          year: currentYear,
          month: currentMonth,
        },
      },
      update: { targetAmount: pgt.monthlyTarget },
      create: {
        productGroup: pgt.group,
        year: currentYear,
        month: currentMonth,
        targetAmount: pgt.monthlyTarget,
        notes: `เป้ายอดขายรายเดือนกลุ่ม ${pgt.group}`,
      },
    });
    ...
    await prisma.productGroupSalesTarget.upsert({
      ...
      update: { targetAmount: pgt.yearlyTarget },
      create: {
        productGroup: pgt.group,
        year: currentYear,
        month: null,
        targetAmount: pgt.yearlyTarget,
        notes: `เป้ายอดขายรายปีกลุ่ม ${pgt.group}`,
      },
    });
  }

  // Monthly Sales Target (Overall)
  await prisma.monthlySalesTarget.upsert({
    ...
    update: { targetAmount: 5000000 },
    create: {
      year: currentYear,
      month: currentMonth,
      targetAmount: 5000000,
      notes: `เป้ายอดขายรวมเดือน ${currentMonth}/${currentYear}`,
    },
  });
  ...
  await prisma.monthlySalesTarget.upsert({
    ...
    update: { targetAmount: 60000000 },
    create: {
      year: currentYear,
      month: null,
      targetAmount: 60000000,
      notes: `เป้ายอดขายรวมปี ${currentYear}`,
    },
  });

  console.log("Sales targets seeded successfully!");
}
