...
const permissionGroups: Record<string, PermissionGroup> = {
    ...
    actions: [
      {
        ...
        name: "จัดการการจัดส่งสินค้า (กำหนดคิว, ขนส่ง, พิมพ์ใบส่งของ)",
        resource: "fulfillment",
        action: "manage",
      },
    ],
  ...
  employees: {
    ...
    actions: [
      ...
      {
        key: "employee.target.manage",
        name: "จัดการเป้าหมายการขายของพนักงาน",
        resource: "employee",
    ...
    subMenus: [
      {
        ...
        name: "เมนูสร้างแผนกิจกรรม",
        resource: "test_activity",
        menuPath: "/test-activity/create-trip-plan",
      },
      {
        key: "menu.test_activity.activity_report",
        name: "เมนูรายงานกิจกรรม",
        resource: "test_activity",
        menuPath: "/test-activity/activity-dashboard",
      },
      {
        key: "menu.test_activity.budget_report",
        name: "เมนูรายงานงบประมาณ",
        resource: "test_activity",
        menuPath: "/test-activity/budget-report",
      },
      {
        key: "menu.test_activity.customer_report",
        name: "เมนูรายงานลูกค้า",
        resource: "test_activity",
        menuPath: "/test-activity/customer-report",
      },
      {
        key: "menu.test_activity.reports",
        name: "เมนูรายงานภาพรวม",
        resource: "test_activity",
        menuPath: "/test-activity/combined-report",
      },
    ],
  },
};
...
const administratorConfig: RolePermItem[] = [
  ...
  { key: "menu.test_activity.trip_plan" },
  { key: "product.approve" },
  { key: "product.copy", dataAccess: DataAccessLevel.VIEW_ALL },
  { key: "product.create" },
  { key: "product.delete" },
  { key: "product.edit" },
  { key: "product.export" },
