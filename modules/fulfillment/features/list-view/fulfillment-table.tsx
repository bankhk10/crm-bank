          ...
          <div className="flex flex-col lg:flex-row gap-4 items-end w-full">
            ...
            <div className="space-y-2 w-full lg:w-[250px]">
              ...
              <MultiSelect
                ...
                defaultValue={statusFilter ?? ["APPROVED"]}
