...
import { listShippingCompaniesUseCase } from "../../application";
import { ShippingCompaniesTable } from "./shipping-companies-table";

interface ShippingCompaniesListViewProps {
    searchParams: {
        page?: string;
        perPage?: string;
        q?: string;
...
export default async function ShippingCompaniesListView({ searchParams }: ShippingCompaniesListViewProps) {
