...
import { getShippingCompanyDetailUseCase } from "../../application";
import { ShippingCompanyDetailView } from "./shipping-company-detail-view";
import type { ShippingCompanyRecord } from "../../types";

interface ShippingCompanyDetailPageViewProps {
    shippingCompanyId: string;
}

export default async function ShippingCompanyDetailPageView({ shippingCompanyId }: ShippingCompanyDetailPageViewProps) {
