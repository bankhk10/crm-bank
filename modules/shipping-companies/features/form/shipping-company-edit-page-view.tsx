...
import { ShippingCompanyEditView } from "./shipping-company-edit-view";

interface ShippingCompanyEditPageViewProps {
    shippingCompanyId: string;
}

export default async function ShippingCompanyEditPageView({ shippingCompanyId }: ShippingCompanyEditPageViewProps) {
