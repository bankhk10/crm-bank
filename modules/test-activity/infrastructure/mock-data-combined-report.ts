...
export const mockActivityLogs: ActivityLogMock[] = [
  {
    ...
    activityType: "เข้าพบร้านค้า / Key Farmer",
  ...
  },
  {
    ...
    activityType: "เข้าพบร้านค้า / Key Farmer",
    customerOrPlot: "ลุงมานะค้าข้าว",
    detail: "นำเสนอสินค้ากลุ่มเพิ่มผลผลิต",
    salesOpportunity: "สูง",
  ...
  },
  {
    ...
    responsible: "สมปอง คำดี",
    activityType: "เข้าพบร้านค้า / Key Farmer",
    customerOrPlot: "ร้านอยู่ดีมีเงิน",
    detail: "พบว่าร้านค้าไม่สต็อกสินค้า",
    salesOpportunity: "กลาง",
...
export interface PlotHealthMock {
  ...
  healthStatus: "สมบูรณ์" | "ไม่เปลี่ยน" | "ทรุดโทรม"; // สภาพพืชรวม
  growthResult: string; // ตัวยาที่ใช้
...
export const mockEventROIs: EventROIMock[] = [
  ...
  },
  {
    ...
    eventName: "จัดกิจกรรมส่งเสริมการขายหน้าร้าน",
  ...
  },
  {
    ...
    eventName: "จัดประชุมการเกษตร / ดีลเลอร์ / ซับดีลเลอร์",
    budgetType: "งบการตลาด",
    budgetUsed: 0,
    participants: 25,
    actualSales: 0,
