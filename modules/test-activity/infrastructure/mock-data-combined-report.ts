...
export const mockActivityLogs: ActivityLogMock[] = [
  {
    ...
    activityType: "ส. เกษตรกรรม",
    customerOrPlot: "ลุงชัย (ทุเรียนชัย)",
    detail: "เข้าพบเกษตรกรแปลงทุเรียน สอบถามปัญหาและแนะนำปุ๋ยสูตรใหม่สำหรับระยะออกดอก",
  ...
  },
  {
    ...
    customerOrPlot: "ลุงชัย (ทุเรียนชัย)",
    detail: "ตรวจสอบราคาและโปรโมชั่นคู่แข่งในพื้นที่ตลาดชุมชน บันทึกรายละเอียดเพื่อวิเคราะห์",
  ...
  },
  {
    ...
    activityType: "รวบรวม / เก็บเงิน",
    customerOrPlot: "วันมีล / เก็บเงิน",
  ...
  },
  {
    ...
    responsible: "สมชาย ใจดี",
    activityType: "ประชุมวิชาการ",
    customerOrPlot: "สมาคมเกษตรกรจังหวัด",
    detail: "ร่วมประชุมวิชาการเกษตร นำเสนอผลิตภัณฑ์ปุ๋ยอินทรีย์ให้ผู้เข้าร่วม 60 ราย",
    salesOpportunity: "กลาง",
...
export const mockStockChecks: StockCheckMock[] = [
  ...
  },
  {
    ...
    storeType: "ซับดีลเลอร์",
    ourProductsStock: "ปุ๋ยสูตร Z",
    stockStatus: "ปกติ",
    stockQty: 30,
    stockUnit: "ถุง",
    competitorBrand: null,
    competitorPromotion: "ลดราคา 10%",
    photoAvailable: true,
  },
  {
    id: "SC-005",
  ...
  },
  {
    ...
    storeType: "ซับดีลเลอร์",
    ourProductsStock: "ปุ๋ยอินทรีย์ C",
    stockStatus: "ปกติ",
    stockQty: 80,
    stockUnit: "กระสอบ",
    competitorBrand: null,
