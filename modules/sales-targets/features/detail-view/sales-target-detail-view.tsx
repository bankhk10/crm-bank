...
import { ChevronLeft, Target, Loader2, MapPin, Calendar, Store, UserRound, Package, Info, History as HistoryIcon } from "lucide-react";
...
interface SalesTargetDetailViewProps {
  id: string;
}

export default function SalesTargetDetailView({ id }: SalesTargetDetailViewProps) {
