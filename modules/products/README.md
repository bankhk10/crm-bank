...
- **`getProductFormOptionsAction`** consolidates 7 separate API calls (units, groups, brands, chemical groups, plants, categories, abc types) into a single server action
