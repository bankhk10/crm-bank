# คู่มือระบบการทำงานฟีเจอร์กิจกรรม (Activity Plan Feature Guide)
...
1.  **`ActivityPlan`:** ตารางเก็บหัวข้อแผนกิจกรรม (ชื่องาน, ประเภท, วันเวลาเริ่ม/จบ, งบประมาณที่ขอใช้, พื้นที่จัดงาน, และสถานะการอนุมัติ)
...
## 🧪 บัญชีทดสอบระบบ (Flow Test Accounts)

ทุกบัญชีใช้รหัสผ่านเดียวคือ **`b@b.com`** สำหรับการทดสอบ Flow:

*   `sales@b.com` (สมชาย - พนักงานฝ่ายขาย) -> ผู้จัดทำและยื่นขอแผนงาน
*   `area@b.com` (สมเจตน์ - ผู้จัดการเขตขาย) -> ผู้อนุมัติสายงานด่านที่ 1
*   `salesadmin@b.com` (สมหญิง - ผจก.แผนกบริหารงานขาย) -> ผู้อนุมัติสายงานด่านสุดท้าย / ผู้อนุมัติงบส่งเสริม / ผู้อนุมัติผู้ช่วยแผนกขาย
*   `marketing@b.com` (มานะ - ผจก.แผนกการตลาด) -> ผู้อนุมัติงบการตลาด / ผู้อนุมัติผู้ช่วยแผนกการตลาด
*   `salesdirector@b.com` (วิชัย - ผู้จัดการฝ่ายขาย/ผอ.) -> ผู้อนุมัติภาพรวมงบประมาณสุดท้าย
*   `helper_sa@b.com` และ `helper_mkt@b.com` -> พนักงานผู้ช่วยงานจัดบูธกิจกรรม
