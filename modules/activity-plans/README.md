...
1.  **`ActivityPlan`:** ตารางเก็บหัวข้อแผนกิจกรรม (เลขที่แผน `code` รูปแบบ `APYYMMXXXX` เช่น `AP26080001`, ชื่องาน, ประเภท, วันเวลาเริ่ม/จบ, งบประมาณที่ขอใช้, พื้นที่จัดงาน, และสถานะการอนุมัติ)
