...
### 2026-08-11: ปรับค่าเริ่มต้น Type 9 (จัดกิจกรรมส่งเสริมการขายหน้าร้าน)
- **คอมโพเนนต์ที่แก้ไข:** `type9-store.tsx`, `activity-plan-form.tsx`
- **รายละเอียด:**
  - ปรับค่าเริ่มต้นของ **เป้ายอดขายรวมจากกิจกรรม (บาท)**, **จำนวน (ลัง)**, **ราคา (บาท)** และ **รวม** ของกิจกรรม Type 9 ให้เริ่มต้นเป็น `0` ทั้งหมด
  - อนุญาตให้ป้อนค่าจำนวน (ลัง) เป็น 0 (`min={0}`) และเมื่อกดเพิ่มสินค้าใหม่จะเริ่มต้นด้วยค่า 0
