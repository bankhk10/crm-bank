...
function TradeNameGroupChart({
  ...
  const chartHeight = isMobile
    ? Math.max(280, filteredTradeNameGroupData.length * 80)
    : 320;
                ...
                <div className="flex items-center gap-2">
                  <div className="w-20 h-1.5 rounded-full bg-slate-100 overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${(jobStatus.success / jobTotal) * 100}%`,
                      }}
                    />
                  </div>
                ...
                <div className="flex items-center gap-2">
                  <div className="w-20 h-1.5 rounded-full bg-slate-100 overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${(jobStatus.progress / jobTotal) * 100}%`,
                      }}
                    />
                  </div>
                  <span className="text-xs font-bold text-slate-700 w-8 text-right">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-20 h-1.5 rounded-full bg-slate-100 overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${(jobStatus.fail / jobTotal) * 100}%`,
                      }}
                    />
                  </div>
                  <span className="text-xs font-bold text-slate-700 w-8 text-right">
        ...
        <Card className="rounded-2xl sm:rounded-3xl border-0 bg-white shadow-lg overflow-hidden">
          <CardHeader className="pb-3 sm:pb-4 border-b border-slate-100/80">
            ...
            <div className="mt-4 pt-4 border-t border-slate-100">
              <div className="flex items-center justify-between mb-2.5">
                <span className="text-[10px] sm:text-xs font-semibold text-slate-600">
                  เลือกกลุ่มชื่อการค้าที่ต้องการแสดง:
                </span>
                <button
