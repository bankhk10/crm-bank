  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {initialData ? "แก้ไขเป้าหมายการขาย" : "เพิ่มเป้าหมายการขาย"}
          </DialogTitle>
        </DialogHeader>
          ...
          <div className="space-y-4 border rounded-xl p-4 bg-slate-50">
            ...
            <div className="space-y-2">
              ...
              {items.map((item, index) => (
                ...
                >
                  ...
                  <div className="w-32">
                    <Label className="text-xs mb-1 block">เป้าหมาย (บาท)</Label>
                    <Input
                      type="number"
                      className="h-8"
                      value={item.amount}
            ...
            {items.length > 0 && (
              <div className="flex justify-end gap-4 text-sm font-medium pt-2">
                <div>รวมจำนวน: {items.reduce((s, i) => s + i.quantity, 0)}</div>
                <div>
                  รวมยอดเงิน: ฿
