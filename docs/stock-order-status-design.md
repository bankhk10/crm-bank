...
1. **อนุมัติรายการขาย → จองสต็อก (Reserve)**
   - เพิ่ม `reservedQuantity` แต่**ไม่ตัด lot**
   - ช่อง "คงเหลือ" ยังคงค่าเดิม
2. **หน้าจัดการสถานะการขาย**:
   - 2.1: **สต็อกคงเหลือถูกตัดเมื่อระบุวันที่จัดส่ง** (ตัด lot + ลด availableQuantity/physicalBalance)
